...
| 21  | [Broken translations: detect, mark, repair](spec-21-broken-translations.md) 🔤       | 15, 19, 20         | 🔍 Verifying (Fable) — gate green; deploying and repairing the Bangla rows in production                                | [plan](plans/spec-21-plan.md)                                          | [notes](notes/spec-21-notes.md) |
