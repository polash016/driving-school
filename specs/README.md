...
| 23  | [Learn: books, chapters & articles](spec-23-learn.md) 📚                          | 01, 02, 03, 05, 06, 15, 18, 20 | 🔍 Verifying (Fable) — all four slices built with tests; production deploy and live draft next | [plan](plans/spec-23-plan.md)                                          | —                               |
