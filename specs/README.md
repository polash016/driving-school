...
| 19  | [Unattended translation & publish readiness](spec-19-translation-automation.md) ⚙️ | 15                 | 🔨 In progress (Fable) — phase 0 ✅ (request deadline), phase 1 ✅ (worker, controls, live progress), phase 2 ✅ (auto-repair); phase 3 next | [plan](plans/spec-19-plan.md)              | [notes](notes/spec-19-notes.md) |
