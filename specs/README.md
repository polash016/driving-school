...
| 22  | [Short, easy questions & bank rewrite](spec-22-short-questions.md) ✂️            | 04, 15, 19, 20, 21 | 🔨 In progress (Opus) — contract ✅ (753 tests); campaign built & tested; prod dry run blocked on deploy permission | —                                                                      | —                               |
